...
(def encrypted-password (password/encrypt "hoge"))

(password/check "hoge" encrypted-password)
(password/check "fuga" encrypted-password)
...
;(add-user! "t.noborio@gmail.com2" "pass2")
...
(defn authentication [email password]
  (if-let [user (collection/find-one-as-map "users" {:_id email})]
...
(change-password! "t.noborio@gmail.com" "pass" "new-pass")
